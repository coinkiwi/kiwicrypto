...
(function() {
  ...
  AES256 = (function() {
    var Base64, addRoundKey, cipher, keyExpansion, mixColumns, rCon, rotWord, sBox, shiftRows, subBytes, subWord;
    ...
    AES256.prototype.encrypt = function(plaintext, key) {
      var b, blockCount, blockLength, blockSize, c, cipherChar, cipherCntr, ciphertext, ciphertxt, counterBlock, ctrTxt, i, keySchedule, nonce, nonceMs, nonceRnd, nonceSec, _i, _j, _k, _l, _m, _n, _o, _p, _ref, _ref1;
      blockSize = 16;
      ...
      for (b = _m = 0, _ref = blockCount - 1; 0 <= _ref ? _m <= _ref : _m >= _ref; b = 0 <= _ref ? ++_m : --_m) {
        for (c = _n = 0; _n <= 3; c = ++_n) {
          counterBlock[15 - c] = (b >>> c * 8) & 0xff;
        }
        for (c = _o = 0; _o <= 3; c = ++_o) {
        ...
        for (i = _p = 0, _ref1 = blockLength - 1; 0 <= _ref1 ? _p <= _ref1 : _p >= _ref1; i = 0 <= _ref1 ? ++_p : --_p) {
    ...
    AES256.prototype.decrypt = function(ciphertext, key) {
      var b, blockSize, c, cipherCntr, counterBlock, ct, ctrTxt, i, keySchedule, nBlocks, plaintext, plaintxt, plaintxtByte, _i, _j, _k, _l, _m, _n, _ref, _ref1, _ref2;
      blockSize = 16;
      ...
      for (b = _k = 0, _ref1 = nBlocks - 1; 0 <= _ref1 ? _k <= _ref1 : _k >= _ref1; b = 0 <= _ref1 ? ++_k : --_k) {
        ...
        for (c = _m = 0; _m <= 3; c = ++_m) {
          counterBlock[15 - c - 4] = (((b + 1) / 0x100000000 - 1) >>> c * 8) & 0xff;
        }
        cipherCntr = cipher(counterBlock, keySchedule);
        plaintxtByte = new Array(ciphertext[b].length);
        for (i = _n = 0, _ref2 = ciphertext[b].length - 1; 0 <= _ref2 ? _n <= _ref2 : _n >= _ref2; i = 0 <= _ref2 ? ++_n : --_n) {
...
},{"Base64":"D+r4VZ"}],"D+r4VZ":[function(require,module,exports){
(function() {
  'use strict';
  var Base64, b64map;
